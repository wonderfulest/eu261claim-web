  ...
  <div class="terms-pro-wrapper">
    ...
    <div class="terms-content">
      ...
      <ul>
        ...
        <li>All rights not expressly granted herein are reserved by WuKong OÜ and its licensors.</li>
      </ul>
      ...
      <ul>
        ...
        <li>To <strong>resell, sublicense, or commercially exploit</strong> the Products without prior written consent from WuKong OÜ.</li>
      </ul>
      ...
      <p>In no event shall WuKong OÜ's total cumulative liability to you for any and all claims relating to the use of the Site or Products <strong>exceed the total amount you paid to WuKong OÜ for the specific Product(s) in question within the six (6) months preceding the event giving rise to the liability.</strong></p>
